...
function Card({card,mode,trump,highlight,winner,onClick,disabled,faceDown,small}) {
  ...
  return(
    <div onClick={!disabled?()=>{sounds.play();onClick&&onClick();}:undefined} style={{
      ...
      <div style={{fontSize:small?9:11,fontWeight:900,color:isRed?T.red:T.night,
        alignSelf:'flex-start',paddingLeft:3,lineHeight:1}}>{card.rank.symbol}</div>
      <div style={{fontSize:small?18:24,color:isRed?T.red:T.night,lineHeight:1}}>
        {card.suit.symbol}</div>
      <div style={{fontSize:small?8:10,color:isRed?T.red:T.night,fontWeight:700}}>
        {card.rank.nameAr}</div>
      {val>0&&(
        <div style={{position:'absolute',top:-7,right:-7,
          background:isTrump?`linear-gradient(135deg,${T.gold},${T.goldL})`
            :`linear-gradient(135deg,${T.green},${T.greenL})`,
          color:isTrump?T.night:'#fff',borderRadius:'50%',width:16,height:16,
          display:'flex',alignItems:'center',justifyContent:'center',
          fontSize:7,fontWeight:900,border:'2px solid white',
          boxShadow:'0 2px 4px #0003'}}>{val}</div>
      )}
      {isTrump&&<div style={{position:'absolute',top:-10,left:'50%',
        transform:'translateX(-50%)',fontSize:10}}>👑</div>}
      {winner&&<div style={{position:'absolute',bottom:-14,left:'50%',
        transform:'translateX(-50%)',fontSize:12}}>🏆</div>}
      {highlight&&<div style={{position:'absolute',inset:-2,borderRadius:11,
        border:`2px solid ${T.greenL}`,animation:'pulse-border 1s infinite',
        pointerEvents:'none'}}/>}
    </div>
  );
}
    ...
    <div style={{position:'fixed',inset:0,background:'#000c',
      ...
      <div style={{background:`linear-gradient(135deg,#0D2A1A,#071f10)`,
        ...
        <div style={{textAlign:'center',marginBottom:20}}>
          ...
          <div style={{color:T.gold,fontSize:20,fontWeight:900}}>
            {profile?.name||user?.displayName||'لاعب'}
          </div>
          <div style={{color:T.smoke,fontSize:12,marginTop:4}}>
            {user?.email}
          </div>
          {profile?.city&&(
            <div style={{color:T.greenL,fontSize:12,marginTop:2}}>
              📍 {profile.city}
            </div>
          )}
        </div>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',
          ...
          {[
            ...
            <div key={s.label} style={{background:'#071f10',
        ...
        {/* Total games */}
        <div style={{background:'#071f10',border:`1px solid ${T.border}`,
          borderRadius:12,padding:'10px',textAlign:'center',marginBottom:16}}>
...
function LeaderboardScreen({onClose,currentUserId}) {
  ...
  const filtered=city==='كل المدن'
    ?players
    :players.filter(p=>p.city===city);
  ...
  return(
    <div style={{position:'fixed',inset:0,background:'#000e',
      ...
      <div style={{background:`linear-gradient(135deg,#071f10,#0a2a0a)`,
        border:`2px solid ${T.gold}`,borderRadius:'0 0 20px 20px',
        padding:'16px 20px',
        ...
        <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
          ...
          <button onClick={onClose} style={{background:'transparent',
            color:T.smoke,border:`1px solid #333`,
        ...
        <div style={{display:'flex',gap:6,marginTop:12,
          ...
          {CITIES.map(c=>(
            <button key={c} onClick={()=>setCity(c)} style={{
              ...
              fontWeight:city===c?700:400,cursor:'pointer',fontSize:12,
              whiteSpace:'nowrap'}}>
              {c}
            </button>
          ))}
      ...
      <div style={{flex:1,overflowY:'auto',padding:'12px 16px'}}>
        {loading?(
          <div style={{textAlign:'center',color:T.smoke,padding:40}}>
            جاري التحميل...
          </div>
        ):filtered.length===0?(
          <div style={{textAlign:'center',color:T.smoke,padding:40}}>
              ...
              <div key={p.id} style={{
                ...
                <div style={{
                  ...
                  background:i===0?`linear-gradient(135deg,${T.gold},${T.goldL})`
                    ...
                    :i===2?`linear-gradient(135deg,#cd7f32,#e8a050)`
                    :'#1a2a1a',
                  display:'flex',alignItems:'center',justifyContent:'center',
                ...
                <div style={{flex:1}}>
                  <div style={{color:isMe?T.gold:T.cream,fontWeight:700,fontSize:14}}>
                    {p.name||'لاعب'}
                    {isMe&&<span style={{color:T.gold,fontSize:10}}> (أنت)</span>}
                  </div>
                  <div style={{color:T.smoke,fontSize:11}}>
                    {p.city||'—'} · {total} مباراة
                  </div>
                </div>
                <div style={{textAlign:'center'}}>
                  <div style={{color:T.greenL,fontSize:18,fontWeight:900}}>
                    {p.wins||0}
                  </div>
                  <div style={{color:T.smoke,fontSize:9}}>انتصار</div>
                </div>
                <div style={{textAlign:'center'}}>
                  <div style={{color:T.gold,fontSize:16,fontWeight:900}}>
                    {wr}%
                  </div>
    ...
    <div style={{position:'fixed',inset:0,
      ...
      <div style={{background:`linear-gradient(135deg,#0D2A1A,#071f10)`,
        ...
        <div style={{textAlign:'center',marginBottom:20}}>
          ...
          <div style={{color:T.gold,fontWeight:900,fontSize:18,
          ...
          {passCount>0&&(
            <div style={{color:T.smoke,fontSize:11,marginTop:4,
              ...
              display:'inline-block'}}>{passCount} پاس قبلك</div>
          )}
        </div>
        {step==='choose'?(
          ...
          <div>
            <div style={{color:T.goldL,fontWeight:700,marginBottom:14,
              textAlign:'center',fontSize:15}}>اختر لون الأتو 👑</div>
    ...
    <div style={{position:'fixed',inset:0,
      ...
      <div style={{background:`linear-gradient(135deg,#0D2A1A,#071f10)`,
        ...
        <div style={{textAlign:'center',
          ...
          textShadow:'0 0 20px currentColor'}}>{result.reason}</div>
        <div style={{display:'flex',gap:12,marginBottom:16}}>
          {[0,1].map(t=>(
            <div key={t} style={{flex:1,
              ...
              <div style={{color:T.gold,fontSize:26,fontWeight:900,
        ...
        <div style={{background:'#071f10',borderRadius:14,padding:14,
          marginBottom:16,border:`1px solid ${T.border}`}}>
          <div style={{color:T.gold,fontSize:12,fontWeight:700,
        ...
        {matchWinner!==null?(
          <div style={{textAlign:'center'}}>
            <div style={{color:T.gold,fontWeight:900,fontSize:22,marginBottom:14,
    ...
    <div style={{minHeight:'100vh',
      ...
      <div style={{textAlign:'center',marginBottom:28}}>
        ...
        <h1 style={{color:T.gold,fontSize:32,fontWeight:900,margin:'0 0 4px',
          textShadow:`0 0 30px ${T.gold}44`,letterSpacing:2}}>
          بلوت المملكة
        </h1>
      ...
      <div style={{background:`linear-gradient(135deg,#071f10,#0a2a0a)`,
        border:`2px solid ${T.gold}`,borderRadius:20,
        padding:'20px 40px',marginBottom:16,textAlign:'center',
      ...
      <div style={{width:'100%',maxWidth:320,marginBottom:20}}>
        <div style={{color:T.smoke,fontSize:11,marginBottom:10,
          ...
          <div key={i} style={{
            ...
            <div style={{flex:1}}>
              <div style={{color:safePlayers[i]?TEAM_COLORS[i%2]:'#444',
                ...
                {i===myIndex&&(
                  <span style={{color:T.gold,fontSize:9,
                    background:`${T.gold}22`,borderRadius:6,
                    padding:'1px 6px',marginRight:6}}> أنت</span>
                )}
              </div>
              <div style={{color:'#555',fontSize:10}}>Team {i%2===0?'A':'B'}</div>
            </div>
            {safePlayers[i]&&(
              <div style={{background:`${T.greenL}22`,color:T.greenL,
...
function ChatPanel({roomCode,userName,avatar}) {
  ...
  useEffect(()=>{
    ...
    const unsub=onSnapshot(
      query(collection(db,'rooms',roomCode,'messages'),
      ...
      {open&&(
        <div style={{position:'absolute',bottom:56,right:0,
          ...
          <div style={{background:'#071f10',padding:'10px 14px',
            ...
            color:T.gold,fontWeight:700,fontSize:13}}>💬 الدردشة</div>
...
export default function App() {
  ...
  const playCard=async(card)=>{
    ...
    if(newPlays.length===4){
      ...
      const update={trickPlays:newPlays,[`h${mi}`]:newHand,
      ...
      if(newHands[0].length===0){
        ...
        // Update stats
        if(mw!==null) updateStats(mw===myIndex%2);
        await updateDoc(doc(db,'rooms',code),{
    ...
    <div style={{minHeight:'100vh',
      ...
      <div style={{position:'absolute',top:16,right:16,left:16,
        ...
        <button onClick={()=>setShowLeaderboard(true)} style={{
          background:'#00000033',color:T.gold,
      ...
      <div style={{textAlign:'center',marginBottom:32,position:'relative',zIndex:1}}>
        ...
        <h1 style={{color:T.gold,fontSize:'clamp(2rem,8vw,3rem)',
          ...
          letterSpacing:3}}>بلوت المملكة</h1>
        <div style={{color:T.smoke,fontSize:14,letterSpacing:1}}>
    ...
    return(
      <div style={{minHeight:'100vh',
        ...
        <div style={{display:'flex',justifyContent:'space-between',
          ...
          <div>
            <div style={{color:T.gold,fontSize:16,fontWeight:900,
              textShadow:`0 0 12px ${T.gold}44`}}>🃏 بلوت المملكة</div>
            {contract&&(
              <div style={{fontSize:10,color:T.smoke,marginTop:1}}>
                {contract.type==='hokum'
                  ?`${contract.trumpName} ${contract.trump} 👑`:'☀️ صن'}
                {' · '}{roomCode}
              </div>
            )}
          </div>
        ...
        {gd.phase==='bidding'&&(
          <>
            <div style={{background:'#00000033',borderRadius:14,
              padding:12,marginBottom:8,border:`1px solid ${T.border}`,
              backdropFilter:'blur(4px)'}}>
          ...
          <div>
            <div style={{display:'flex',gap:8,marginBottom:8,alignItems:'stretch'}}>
              <div style={{flex:1,
                ...
                <div style={{color:contract.type==='sun'?T.gold:T.greenL,
            ...
            <div style={{
              ...
              {[0,1,2,3].map(i=>(
                <div key={i} style={{position:'absolute',
                  ...
                  width:16,height:16,
                  border:`2px solid ${T.gold}33`,borderRadius:3}}/>
              ))}
              ...
              <div style={{display:'flex',alignItems:'center',
                ...
                <div style={{flex:1,display:'flex',flexDirection:'column',
                  ...
                  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:6,
                    padding:10,background:'#00000033',borderRadius:16,
                    border:`1px solid ${T.gold}22`,backdropFilter:'blur(4px)',
                      ...
                      return(
                        <div key={pIdx} style={{display:'flex',flexDirection:'column',
                          ...
                          {play?(
                            ...
                            <div style={{width:38,height:54,borderRadius:8,
                              border:`1px dashed ${T.gold}22`,
                              display:'flex',alignItems:'center',justifyContent:'center',
                              color:`${T.gold}22`,fontSize:18}}>•</div>
                          )}
                        </div>
                      );
                    })}
                  ...
                  {!gd.trickResult&&activePIdx>=0&&(
                    <div style={{color:isMyTurn?T.greenL:T.smoke,
              ...
              <div style={{display:'flex',flexDirection:'column',alignItems:'center'}}>
                <PlayerBadge
                  ...
                  isActive={isMyTurn} isMe={true} timer={timer}
                />
                {isMyTurn&&(
                  <div style={{height:4,width:200,background:'#1a2a1a',
    ...
    <div style={{minHeight:'100vh',background:T.felt,
      ...
      <div style={{textAlign:'center'}}>
        ...
        <div style={{color:T.gold,fontSize:18,fontWeight:700,
          textShadow:`0 0 20px ${T.gold}44`}}>جاري التحميل...</div>
      </div>
      <style>{`@keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-8px)}}`}</style>
    </div>
  );
